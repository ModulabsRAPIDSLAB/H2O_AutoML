...
| **3. Build** | paged_automl/ 프레임워크 구현 + RTX 4060에서 검증 | 8GB GPU에서 OOM 0건, **앙상블이 개별 모델보다 우수** | [docs/03-results/](docs/03-results/) |
...
| # | Notebook | Phase | 내용 | 실행 |
|:-:|----------|:-----:|------|:----:|
| 1 | [01_h2o_automl_demo.ipynb](notebooks/01_h2o_automl_demo.ipynb) | Research | H2O AutoML CPU baseline 데모 | CPU |
| 2 | [02_explainability.ipynb](notebooks/02_explainability.ipynb) | Research | h2o.explain() 시각화 | CPU |
| 3 | [03_gpu_native_redesign.ipynb](notebooks/03_gpu_native_redesign.ipynb) | Design | GPU-native 매핑 분석 (개념 설계) | 읽기만 |
| 4 | [04_paged_automl_benchmark.ipynb](notebooks/04_paged_automl_benchmark.ipynb) | **Results** | **실제 데이터(Credit Card Fraud)로 paged_automl 벤치마크** | GPU |
