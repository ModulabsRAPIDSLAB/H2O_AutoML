...
## Phase 5: GTC 2027 — GPU-Native E2E AutoML

> **2026-04-14 스코프 전환**: 세미나 데모 → GTC 2027 정규세션 투고용 연구. RAPIDS 커널 기반 preprocessing 자동화를 핵심 기여로 재포지셔닝.

| 문서 | 내용 |
|------|------|
| [00_strategic_direction.md](05-gtc-2027/00_strategic_direction.md) | 전략 방향 전환, 포지셔닝, 4종 baseline 확정, 3개월 타임라인 |
| [01_PRD.md](05-gtc-2027/01_PRD.md) | 상세 요구사항 정의서 (Goals/Non-Goals, Operator 카탈로그, 벤치마크 방법론, 마일스톤, 리스크) |
